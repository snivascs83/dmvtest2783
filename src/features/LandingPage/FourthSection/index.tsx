...
function FourthSection() {
  return (
    <div>
      <div className="flex flex-col gap-[30px] p-[20px] md:flex md:flex-1 md:flex-row-reverse md:justify-between md:gap-[80px] md:px-[60px] md:pb-[40px]">
        <div>
          <Image
            src="/images/Group 1188.png"
            alt=""
            width={350.2}
            height={388.44}
            className="md:h-[601.56px] md:w-[542.35px]"
          />
        </div>
